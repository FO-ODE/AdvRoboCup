...
add_custom_target(minimind_chat_ros_generate_messages ALL)
...
_generate_module_cpp(minimind_chat_ros
  ${CATKIN_DEVEL_PREFIX}/${gencpp_INSTALL_DIR}/minimind_chat_ros
  "${ALL_GEN_OUTPUT_FILES_cpp}"
)

add_custom_target(minimind_chat_ros_generate_messages_cpp
...
add_custom_target(minimind_chat_ros_gencpp)
add_dependencies(minimind_chat_ros_gencpp minimind_chat_ros_generate_messages_cpp)

# register target for catkin_package(EXPORTED_TARGETS)
list(APPEND ${PROJECT_NAME}_EXPORTED_TARGETS minimind_chat_ros_generate_messages_cpp)
...
### Generating Module File
_generate_module_eus(minimind_chat_ros
  ${CATKIN_DEVEL_PREFIX}/${geneus_INSTALL_DIR}/minimind_chat_ros
  "${ALL_GEN_OUTPUT_FILES_eus}"
)

add_custom_target(minimind_chat_ros_generate_messages_eus
...
# target for backward compatibility
add_custom_target(minimind_chat_ros_geneus)
add_dependencies(minimind_chat_ros_geneus minimind_chat_ros_generate_messages_eus)

# register target for catkin_package(EXPORTED_TARGETS)
list(APPEND ${PROJECT_NAME}_EXPORTED_TARGETS minimind_chat_ros_generate_messages_eus)
...
### Generating Module File
_generate_module_lisp(minimind_chat_ros
  ${CATKIN_DEVEL_PREFIX}/${genlisp_INSTALL_DIR}/minimind_chat_ros
  "${ALL_GEN_OUTPUT_FILES_lisp}"
)

add_custom_target(minimind_chat_ros_generate_messages_lisp
...
# target for backward compatibility
add_custom_target(minimind_chat_ros_genlisp)
add_dependencies(minimind_chat_ros_genlisp minimind_chat_ros_generate_messages_lisp)

# register target for catkin_package(EXPORTED_TARGETS)
list(APPEND ${PROJECT_NAME}_EXPORTED_TARGETS minimind_chat_ros_generate_messages_lisp)
...
### Generating Module File
_generate_module_nodejs(minimind_chat_ros
  ${CATKIN_DEVEL_PREFIX}/${gennodejs_INSTALL_DIR}/minimind_chat_ros
  "${ALL_GEN_OUTPUT_FILES_nodejs}"
)

add_custom_target(minimind_chat_ros_generate_messages_nodejs
...
# target for backward compatibility
add_custom_target(minimind_chat_ros_gennodejs)
add_dependencies(minimind_chat_ros_gennodejs minimind_chat_ros_generate_messages_nodejs)

# register target for catkin_package(EXPORTED_TARGETS)
list(APPEND ${PROJECT_NAME}_EXPORTED_TARGETS minimind_chat_ros_generate_messages_nodejs)
...
### Generating Module File
_generate_module_py(minimind_chat_ros
  ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/minimind_chat_ros
  "${ALL_GEN_OUTPUT_FILES_py}"
)

add_custom_target(minimind_chat_ros_generate_messages_py
...
# target for backward compatibility
add_custom_target(minimind_chat_ros_genpy)
add_dependencies(minimind_chat_ros_genpy minimind_chat_ros_generate_messages_py)

# register target for catkin_package(EXPORTED_TARGETS)
list(APPEND ${PROJECT_NAME}_EXPORTED_TARGETS minimind_chat_ros_generate_messages_py)



if(gencpp_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${gencpp_INSTALL_DIR}/minimind_chat_ros)
  # install generated code
  install(
    DIRECTORY ${CATKIN_DEVEL_PREFIX}/${gencpp_INSTALL_DIR}/minimind_chat_ros
...
if(geneus_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${geneus_INSTALL_DIR}/minimind_chat_ros)
  # install generated code
  install(
    DIRECTORY ${CATKIN_DEVEL_PREFIX}/${geneus_INSTALL_DIR}/minimind_chat_ros
...
if(genlisp_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genlisp_INSTALL_DIR}/minimind_chat_ros)
  # install generated code
  install(
    DIRECTORY ${CATKIN_DEVEL_PREFIX}/${genlisp_INSTALL_DIR}/minimind_chat_ros
...
if(gennodejs_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${gennodejs_INSTALL_DIR}/minimind_chat_ros)
  # install generated code
  install(
    DIRECTORY ${CATKIN_DEVEL_PREFIX}/${gennodejs_INSTALL_DIR}/minimind_chat_ros
